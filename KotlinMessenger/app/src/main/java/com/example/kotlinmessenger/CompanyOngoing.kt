...
import com.example.kotlinmessenger.adapters.AdapterOngoingJob
 ...
 * Use the [CompanyOngoing.newInstance] factory method to
 * create an instance of this fragment.
 */
class CompanyOngoing : Fragment() {
...
//                    Log.w("ada", document.get("id").toString())
                }
                recyclerview.layoutManager = LinearLayoutManager(view?.context)
                recyclerview.adapter = AdapterOngoingJob(parentFragmentManager, listjobs, false)
            }
    ...
    companion object {
         ...
         * @return A new instance of fragment CompanyOngoing.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CompanyOngoing().apply {
